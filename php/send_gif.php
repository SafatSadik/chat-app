<?php
if(isset($_POST['sender']) && isset($_POST['reciever']) && isset($_POST['gif_url'])){
    require "connect.php";
    $sender = $_POST['sender'];
    $reciever = $_POST['reciever'];
    $gif_url = $_POST['gif_url'];
    
    $query = "INSERT INTO `messege` (`sender_id`,`reciever_id`,`msg`,`picture`) VALUES ('$sender','$reciever','','$gif_url')";
